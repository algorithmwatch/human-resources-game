  ...
  rounds: [
    {
      ...
      introduction:
        '<p>Wer sollte befördert werden? Helfen Sie mit, das Neuronale Netz des Personalmanagement-Tools zu optimieren. Die fünf dunkelgelb markierten Kreise stellen Mitarbeiter·innen dar, die befördert werden sollten.</b>.</p><p>Sie müssen von Ihnen auf der Skala in das rechte Zielfeld bewegt werden –- es sollen sich alleine diese Kreise im Zielfeld befinden. Nutzen Sie die Schieberegler entsprechend, um die "Gewichte" an den "Kanten" des Neuronalen Netzes zu justieren.</p> <p>Achten Sie auf die Bezeichnung der Eingangsknoten links.</p><p>Bevor die Runde beginnt, können Sie sich das Puzzle in Ruhe ansehen. Sobald Sie “Starten” klicken, haben Sie 30 Sekunden Zeit.</p> ',
      result_top:
