...
const config = {
  ...
  mobileRedirect: 'https://algorithmwatch.org/de/auto-hr/hrpuzzle-mobil',
  ...
  rounds: [
    {
      ...
      introduction:
        '<p>Wer sollte befördert werden? Helfen Sie mit, das Neuronale Netz des Personalmanagement-Tools zu optimieren. Die  dunkelgelb markierten Kreise stellen Mitarbeiter·innen dar, die befördert werden sollten. Sie müssen von Ihnen auf der Skala in das rechte Zielfeld bewegt werden – fünf grüne Kreise sollen sich alleine im Zielfeld befinden.</p><p><img src="https://algorithmwatch.org/de/hrpuzzle/public/goalde.png" width="450px"></p>Nutzen Sie die Schieberegler entsprechend, um die "Gewichte" an den "Kanten" des Neuronalen Netzes zu justieren.</p><p>Achten Sie auf die Bezeichnung der Eingangsknoten der Daten links.</p><p><img src="https://algorithmwatch.org/de/hrpuzzle/public/neuralde.png" width="450px"></p><p>Bevor die Runde beginnt, können Sie sich das Puzzle in Ruhe ansehen. Sobald Sie “Starten” klicken, haben Sie 30 Sekunden Zeit.</p> ',
      result_top:
