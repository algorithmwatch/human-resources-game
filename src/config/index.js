  ...
  rounds: [
    {
      ...
      introduction:
        '<p>Who should be promoted? Help to optimize the neural network of the HR management tool!</p><p>The five circles filled with dark yellow represent employees to be promoted. You have to move them to the right side of the scale - only these circles should be in the target field.</p> Use the sliders accordingly to adjust the "weights" at the "edges" of the neural network - you can only move some of the weights.</p><p>Pay attention to the labels of the input nodes on the left.</p><p>Before starting the round you have time to look at the puzzle. Once you click "Start", you have 30 seconds to complete it.</p> ',
      result_top:
